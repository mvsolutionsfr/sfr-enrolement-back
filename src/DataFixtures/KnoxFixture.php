...
// php bin/console --env=test --purge-with-truncate doctrine:fixtures:load --group=knox
class KnoxFixture extends Fixture implements FixtureGroupInterface
{
...
//        $this->creeTerminaux(2, $fabricantApple, $this->pgmApple, $clientTA);
          ...
          $this->creeTerminaux(5, $this->fabricantSamsung, $this->pgmKnox, $clientMV);
