...
// php bin/console --env=test --purge-with-truncate doctrine:fixtures:load --group=zt
class ZTFixture extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $clientMV = $this->createClient("MV SOLUTIONS", "Eric RAVE", $enseigne,$utilisateur, $this->pgmZT, "1252693692");
//        $clientTA = $this->createClient("TOURAINE ALARME", "Frédéric NEVEU", $enseigne,$utilisateur, $this->pgmZT, "54646464");


 //       $this->setPgmToClient($clientMV,$this->pgmApple,"XXXXXXX");
 //       $this->setPgmToClient($clientMV,$this->pgmKnox,"35863870");
 //       $this->setPgmToClient($clientMV,$this->pgmZT,"35863870");
...
//        $this->creeTerminaux(4, $fabricantApple, $this->pgmApple, $clientMV);
//        $this->creeTerminaux(2, $fabricantApple, $this->pgmApple, $clientTA);

//        $this->creeTerminaux(5, $this->fabricant, $this->pgmZT, $clientMV);
//          $this->creeTerminaux(3, $fabricantSamsung, $this->pgmKnox, $clientVINCI);
//        $this->creeTerminaux(5, $fabricantSamsung, $this->pgmKnox, $clientDIOR);
//        $this->creeTerminaux(7, $fabricantSamsung, $this->pgmKnox, $clientFNAC);
//        $this->creeTerminaux(2, $fabricantSamsung, $this->pgmKnox, $clientAUCHAN);
//        $this->creeTerminaux(8, $fabricantSamsung, $this->pgmKnox, $clientSKF);
//        $this->creeTerminaux(1, $fabricantSamsung, $this->pgmKnox, $clientSNCF);
//        $this->creeTerminaux(6, $fabricantSamsung, $this->pgmKnox, $clientBOUYGUES);
        ...
        //       $this->enrolementService->enrolement($admin,$this->pgmApple,$clientMV,$enseigne,"Enrolement1",$imeis,$fabricantApple);
    }
    ...
    private function chargeFabricant(): void
    {
        ...
        $this->fabricant = new Fabricant(); $this->fabricant->setLibelle("Crosscall"); $this->fabricant->setCode("CROSSCALL"); $manager->persist($this->fabricant);
        ...
        $fabricant = new Fabricant(); $fabricant->setLibelle("Samsung"); $fabricant->setCode("Samsung"); $manager->persist($fabricant);
