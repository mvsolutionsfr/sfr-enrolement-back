...
// php bin/console app:correctionimei
// the name of the command is what users type after "php bin/console app:migration"
#[AsCommand(
    name: 'app:correctionimei',
    description: '',
    hidden: false
)]
class CorrectionImeiCommand extends Command
{
