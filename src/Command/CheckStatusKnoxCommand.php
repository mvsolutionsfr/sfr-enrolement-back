...
class CheckStatusKnoxCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $depResellerId=$input->getArgument("resellerId");
        $tid=$input->getArgument("tid");

        $retour = $this->knoxRestService->checkTransactionStatus($depResellerId, $tid);

        $output->writeln($retour);
    ...
    protected function configure(): void
    {
        ...
        $this->addArgument('resellerId', InputArgument::REQUIRED, "ResellerId de l'enseigne ");
        $this->addArgument('tid', InputArgument::REQUIRED, "transaction id ");
