...
class ListCommandesClient extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $client = $this->doctrine->getRepository(Terminal::class)->findBy(['numeroIMEI' => $imei]);
    ...
    protected function configure(): void
    {
        ...
        $this
            // ...
            ->addArgument('clientId', InputArgument::REQUIRED, "id du client");;
    }
